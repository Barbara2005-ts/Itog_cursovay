  ...
  const levelsData = [
      {
          ...
          phrase: "Ш-ш-ш! Я знаю все лесные ягоды! Малина зреет на побегах второго года, а земляника прячет семечки снаружи!",
          facts: [
              "Черника улучшает зрение благодаря антоцианам",
              "Брусника не боится морозов и может расти даже в тундре",
              "Ягоды бузины ядовиты в сыром виде"
          ]
      },
      {
          title: "Транспорт",
